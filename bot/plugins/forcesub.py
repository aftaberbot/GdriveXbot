    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="**Sorry Dude, You are Banned to use me. \n Contact my Creator.**",
                parse_mode="markdown",
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("⭕ Join My Updates Channel ⭕", url=invite_link.invite_link)
                    ],
                    [
                        InlineKeyboardButton("🔄 Refresh 🔄", url="https://telegram.me/tggdrivexbot?start=start")
                    ]
                ]
            ),
            parse_mode="markdown"
